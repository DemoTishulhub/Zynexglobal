            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-start gap-2.5">
                ...
                <div className="flex flex-col">
                  <a href="tel:+917983006995" className="transition-colors hover:text-white">+91 7983006995</a>
                  <a href="tel:+919625289043" className="transition-colors hover:text-white">+91 9625289043</a>
                </div>
              </li>
              <li className="flex items-start gap-2.5">
                <Mail size={16} className="mt-0.5 shrink-0 text-gray-500" />
                <a href="mailto:admin@zynexglobal.in" className="transition-colors hover:text-white">
